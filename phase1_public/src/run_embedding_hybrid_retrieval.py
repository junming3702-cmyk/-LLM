...
CORPUS = ROOT / "data" / "rag" / "corpus_chunks_public_sample.jsonl"
LABELS = ROOT / "data" / "gold" / "contract_review_final_synthetic_gold_v1.jsonl"
OUT_DIR = ROOT / "runs" / "embedding_hybrid_v1"
TOP_K = 10
VECTOR_WEIGHT = 0.40
BM25_WEIGHT = 0.60
