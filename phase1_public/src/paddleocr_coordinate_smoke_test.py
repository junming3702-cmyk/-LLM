...
def main() -> None:
    ...
    parser.add_argument("--pages", default="1,2,3,4,5,10,320")
    ...
    quality_path.write_text(json.dumps({"source_file": str(args.input), "source_sha256": source_hash, "pages": quality_rows, "overall_status": "needs_human_review"}, ensure_ascii=False, indent=2), encoding="utf-8")
