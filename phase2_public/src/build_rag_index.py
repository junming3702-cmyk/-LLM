...
EXTRACTED = Path(os.environ.get("LAW_EXTRACTED_DIR", ROOT / "law_extracted")).expanduser().resolve()
OUT = Path(os.environ.get("RAG_INDEX_DIR", ROOT / "data" / "rag")).expanduser().resolve()
...
def main() -> None:
    ...
    catalog = {
        ...
        "source_root": str(ROOT / "law_sources"),
