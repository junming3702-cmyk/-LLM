...
def apply_gate(raw_response: Any, runtime_input: dict, *, risk_binding: bool = False, external_scope_bridge: bool = False, source_role_guard: bool = False, external_auto_candidates: bool = False, nu_boundary: bool = False, task_contract_v2: bool = False, scope_dependency_v4: dict | None = None) -> dict:
    """Return raw-preserving gate result with a safe final response."""

    task_contract_v2 = task_contract_v2 or scope_dependency_v4 is not None
    ...
    return {
        "status": "blocked" if technical_blocked else "corrected" if actions else "passed",
